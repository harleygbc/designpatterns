...
modifier marksWithInRange(address _studentAddress, uint mark){
        require(mark > 0 && mark <= 100, "Marks should not be above 100");
        _;
    } 
...
// into one user defined type. 
    ...
    function adding_values(address _address, string memory _name, string memory _subject, uint8 _mark) public marksWithInRange(_address, _mark) { 
